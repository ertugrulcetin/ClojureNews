...
goog.addDependency("../view/login.js", ['view.login'], ['cljs.core', 'controller.login']);
goog.addDependency("../route/login.js", ['route.login'], ['reagent.core', 'cljs.core', 'secretary.core', 'util.view', 'view.login']);
goog.addDependency("../controller/entry.js", ['controller.entry'], ['ajax.core', 'cljs.core', 'util.view']);
...
goog.addDependency("../view/user.js", ['view.user'], ['cljs.core', 'clojure.string']);
goog.addDependency("../controller/user.js", ['controller.user'], ['goog.dom', 'ajax.core', 'reagent.core', 'cljs.core', 'cljc.validation', 'cljc.string_util', 'util.view', 'view.user', 'clojure.string']);
...
goog.addDependency("../cljs/main.js", ['cljs.main'], ['goog.dom', 'route.login', 'goog.History.EventType', 'route.entry', 'reagent.core', 'cljs.core', 'goog.History', 'route.user', 'secretary.core', 'route.forgot_password', 'goog.events']);
