...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__24653__auto__,writer__24654__auto__,opt__24655__auto__){
return cljs.core._write.call(null,writer__24654__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__25648 = o;
(G__25648[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__25649__delegate = function (args){
...
while (G__25650__i < G__25650__a.length) {G__25650__a[G__25650__i] = arguments[G__25650__i + 0]; ++G__25650__i;}
  args = new cljs.core.IndexedSeq(G__25650__a,0);
} 
return G__25649__delegate.call(this,args);};
G__25649.cljs$lang$maxFixedArity = 0;
G__25649.cljs$lang$applyTo = (function (arglist__25651){
var args = cljs.core.seq(arglist__25651);
return G__25649__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__24035__auto__ = cljs.core.some_QMARK_.call(null,reagent.impl.template.find_dom_node);
if(and__24035__auto__){
var and__24035__auto____$1 = cljs.core.some_QMARK_.call(null,jsprops);
if(and__24035__auto____$1){
var and__24035__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
...
var G__25656 = jsprops;
(G__25656["defaultValue"] = value);

(G__25656["onChange"] = ((function (G__25656,v,value,on_change){
return (function (p1__25654_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__25654_SHARP_);
});})(G__25656,v,value,on_change))
);
...
var vec__25661 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__25661,(0),null);
var id = cljs.core.nth.call(null,vec__25661,(1),null);
var class$ = cljs.core.nth.call(null,vec__25661,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___25664 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___25664 == null)){
} else {
var key_25665 = temp__4661__auto___25664;
(jsprops["key"] = key_25665);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__25667 = (new reagent.impl.template.NativeWrapper());
(G__25667["name"] = c);
...
var len__25117__auto___25673 = arguments.length;
var i__25118__auto___25674 = (0);
while(true){
if((i__25118__auto___25674 < len__25117__auto___25673)){
args__25124__auto__.push((arguments[i__25118__auto___25674]));

var G__25675 = (i__25118__auto___25674 + (1));
i__25118__auto___25674 = G__25675;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__25125__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq25671){
var G__25672 = cljs.core.first.call(null,seq25671);
var seq25671__$1 = cljs.core.next.call(null,seq25671);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__25672,seq25671__$1);
});
...
break;
default:
var G__25679 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__25679;
continue;
...
var n__24962__auto___25682 = a.length;
var i_25683 = (0);
while(true){
if((i_25683 < n__24962__auto___25682)){
(a[i_25683] = reagent.impl.template.as_element.call(null,(a[i_25683])));
...
var a = cljs.core.into_array.call(null,s);
var n__24962__auto___25685 = a.length;
var i_25686 = (0);
while(true){
if((i_25686 < n__24962__auto___25685)){
var val_25687 = (a[i_25686]);
if((cljs.core.vector_QMARK_.call(null,val_25687)) && ((reagent.impl.template.key_from_vec.call(null,val_25687) == null))){
(o["no-key"] = true);
} else {
}

(a[i_25686] = reagent.impl.template.as_element.call(null,val_25687));
...
var ctx = {};
var vec__25690 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__25690,(0),null);
var derefed = cljs.core.nth.call(null,vec__25690,(1),null);
...
var G__25692 = (cljs.core.count.call(null,argv) - first_child);
switch (G__25692) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__25692){
