...
var and__22494__auto__ = !(clojure.string.blank_QMARK_.call(null,username));
if(and__22494__auto__){
return cljs.core.re_matches.call(null,/[a-zA-Z_0-9]{2,15}/,username);
} else {
return and__22494__auto__;
}
});
/**
...
var and__22494__auto__ = !(clojure.string.blank_QMARK_.call(null,password));
if(and__22494__auto__){
...
var or__22506__auto__ = clojure.string.blank_QMARK_.call(null,url);
if(or__22506__auto__){
return or__22506__auto__;
} else {
...
var or__22506__auto__ = clojure.string.blank_QMARK_.call(null,email);
if(or__22506__auto__){
return or__22506__auto__;
} else {
...
var or__22506__auto__ = clojure.string.blank_QMARK_.call(null,username);
if(or__22506__auto__){
return or__22506__auto__;
} else {
var and__22494__auto__ = cljs.core.not.call(null,cljc.validation.url_QMARK_.call(null,username));
if(and__22494__auto__){
...
var or__22506__auto__ = clojure.string.blank_QMARK_.call(null,about);
if(or__22506__auto__){
return or__22506__auto__;
} else {
