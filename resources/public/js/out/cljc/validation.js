...
var and__23251__auto__ = !(clojure.string.blank_QMARK_.call(null,username));
...
var and__23251__auto__ = !(clojure.string.blank_QMARK_.call(null,password));
if(and__23251__auto__){
...
var or__23263__auto__ = clojure.string.blank_QMARK_.call(null,url);
if(or__23263__auto__){
...
var or__23263__auto__ = clojure.string.blank_QMARK_.call(null,email);
if(or__23263__auto__){
return or__23263__auto__;
} else {
...
var or__23263__auto__ = clojure.string.blank_QMARK_.call(null,username);
if(or__23263__auto__){
return or__23263__auto__;
} else {
var and__23251__auto__ = cljs.core.not.call(null,cljc.validation.url_QMARK_.call(null,username));
if(and__23251__auto__){
var and__23251__auto____$1 = !(clojure.string.includes_QMARK_.call(null,username," "));
...
var and__23251__auto__ = !(clojure.string.blank_QMARK_.call(null,url));
if(and__23251__auto__){
var and__23251__auto____$1 = (cljs.core.count.call(null,url) <= (500));
if(and__23251__auto____$1){
return cljs.core.re_matches.call(null,/^(https?|ftp|file):\/\/[-a-zA-Z0-9+&@#\/%?=~_|!:,.;]*[-a-zA-Z0-9+&@#\/%=~_|]/,url);
} else {
return and__23251__auto____$1;
