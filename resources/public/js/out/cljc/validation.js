...
var and__23709__auto__ = !(clojure.string.blank_QMARK_.call(null,username));
...
var and__23709__auto__ = !(clojure.string.blank_QMARK_.call(null,password));
if(and__23709__auto__){
...
var or__23721__auto__ = clojure.string.blank_QMARK_.call(null,url);
if(or__23721__auto__){
return or__23721__auto__;
} else {
var and__23709__auto__ = cljs.core.re_matches.call(null,/^(https?|ftp|file):\/\/[-a-zA-Z0-9+&@#\/%?=~_|!:,.;]*[-a-zA-Z0-9+&@#\/%=~_|]/,url);
...
var or__23721__auto__ = clojure.string.blank_QMARK_.call(null,email);
if(or__23721__auto__){
return or__23721__auto__;
} else {
...
var or__23721__auto__ = clojure.string.blank_QMARK_.call(null,username);
if(or__23721__auto__){
return or__23721__auto__;
} else {
var and__23709__auto__ = cljs.core.not.call(null,cljc.validation.url_QMARK_.call(null,username));
if(and__23709__auto__){
var and__23709__auto____$1 = !(clojure.string.includes_QMARK_.call(null,username," "));
if(and__23709__auto____$1){
return cljs.core.re_matches.call(null,/.{1,40}/,username);
} else {
return and__23709__auto____$1;
}
} else {
return and__23709__auto__;
}
...
var and__23709__auto__ = !(clojure.string.blank_QMARK_.call(null,url));
if(and__23709__auto__){
var and__23709__auto____$1 = (cljs.core.count.call(null,url) <= (500));
if(and__23709__auto____$1){
var and__23709__auto____$2 = cljs.core.re_matches.call(null,/^(https?|ftp|file):\/\/[-a-zA-Z0-9+&@#\/%?=~_|!:,.;]*[-a-zA-Z0-9+&@#\/%=~_|]/,url);
if(cljs.core.truth_(and__23709__auto____$2)){
return ((cljs.core.count.call(null,clojure.string.split.call(null,cljc.validation.get_pure_url.call(null,url),/[.]/)) >= (2))) && ((cljs.core.count.call(null,cljs.core.last.call(null,clojure.string.split.call(null,cljc.validation.get_pure_url.call(null,url),/[.]/))) >= (2)));
} else {
return and__23709__auto____$2;
}
} else {
return and__23709__auto____$1;
}
