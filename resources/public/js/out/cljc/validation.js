...
var and__23739__auto__ = !(clojure.string.blank_QMARK_.call(null,username));
if(and__23739__auto__){
return cljs.core.re_matches.call(null,/[a-zA-Z_0-9]{2,15}/,username);
} else {
return and__23739__auto__;
}
});
/**
...
var and__23739__auto__ = !(clojure.string.blank_QMARK_.call(null,password));
if(and__23739__auto__){
...
var or__23751__auto__ = clojure.string.blank_QMARK_.call(null,url);
if(or__23751__auto__){
return or__23751__auto__;
} else {
var and__23739__auto__ = cljs.core.re_matches.call(null,/^(https?|ftp|file):\/\/[-a-zA-Z0-9+&@#\/%?=~_|!:,.;]*[-a-zA-Z0-9+&@#\/%=~_|]/,url);
if(cljs.core.truth_(and__23739__auto__)){
...
var or__23751__auto__ = clojure.string.blank_QMARK_.call(null,email);
if(or__23751__auto__){
return or__23751__auto__;
} else {
...
var or__23751__auto__ = clojure.string.blank_QMARK_.call(null,username);
if(or__23751__auto__){
return or__23751__auto__;
} else {
var and__23739__auto__ = cljs.core.not.call(null,cljc.validation.url_QMARK_.call(null,username));
if(and__23739__auto__){
var and__23739__auto____$1 = !(clojure.string.includes_QMARK_.call(null,username," "));
if(and__23739__auto____$1){
return cljs.core.re_matches.call(null,/.{1,40}/,username);
} else {
return and__23739__auto____$1;
}
} else {
return and__23739__auto__;
}
...
var and__23739__auto__ = !(clojure.string.blank_QMARK_.call(null,url));
if(and__23739__auto__){
var and__23739__auto____$1 = (cljs.core.count.call(null,url) <= (500));
if(and__23739__auto____$1){
var and__23739__auto____$2 = cljs.core.re_matches.call(null,/^(https?|ftp|file):\/\/[-a-zA-Z0-9+&@#\/%?=~_|!:,.;]*[-a-zA-Z0-9+&@#\/%=~_|]/,url);
if(cljs.core.truth_(and__23739__auto____$2)){
return ((cljs.core.count.call(null,clojure.string.split.call(null,cljc.validation.get_pure_url.call(null,url),/[.]/)) >= (2))) && ((cljs.core.count.call(null,cljs.core.last.call(null,clojure.string.split.call(null,cljc.validation.get_pure_url.call(null,url),/[.]/))) >= (2)));
} else {
return and__23739__auto____$2;
}
} else {
return and__23739__auto____$1;
}
...
cljc.validation.submit_month_QMARK_ = (function cljc$validation$submit_month_QMARK_(day){
return ((parseInt(day) >= (1))) && ((parseInt(day) <= (12)));
});
cljc.validation.submit_year_QMARK_ = (function cljc$validation$submit_year_QMARK_(day){
return ((parseInt(day) >= (2016))) && ((parseInt(day) <= (2056)));
});
