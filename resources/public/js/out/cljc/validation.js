...
var and__22592__auto__ = !(clojure.string.blank_QMARK_.call(null,username));
if(and__22592__auto__){
return cljs.core.re_matches.call(null,/[a-zA-Z_0-9]{2,15}/,username);
} else {
return and__22592__auto__;
}
});
/**
...
var and__22592__auto__ = !(clojure.string.blank_QMARK_.call(null,password));
if(and__22592__auto__){
...
var or__22604__auto__ = clojure.string.blank_QMARK_.call(null,url);
if(or__22604__auto__){
return or__22604__auto__;
} else {
...
var or__22604__auto__ = clojure.string.blank_QMARK_.call(null,email);
if(or__22604__auto__){
return or__22604__auto__;
} else {
...
var or__22604__auto__ = clojure.string.blank_QMARK_.call(null,username);
if(or__22604__auto__){
return or__22604__auto__;
} else {
var and__22592__auto__ = cljs.core.not.call(null,cljc.validation.url_QMARK_.call(null,username));
if(and__22592__auto__){
var and__22592__auto____$1 = !(clojure.string.includes_QMARK_.call(null,username," "));
if(and__22592__auto____$1){
return cljs.core.re_matches.call(null,/.{1,40}/,username);
} else {
return and__22592__auto____$1;
}
} else {
return and__22592__auto__;
}
...
return cljs.core.contains_QMARK_.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, ["entry",null,"question",null,"events",null,"jobs",null], null), null),type);
});
...
var and__22592__auto__ = !(clojure.string.blank_QMARK_.call(null,url));
if(and__22592__auto__){
return cljs.core.re_matches.call(null,/^(https?|ftp|file):\/\/[-a-zA-Z0-9+&@#\/%?=~_|!:,.;]*[-a-zA-Z0-9+&@#\/%=~_|]/,url);
} else {
return and__22592__auto__;
