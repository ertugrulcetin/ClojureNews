...
var h_23759 = (new goog.History());
goog.events.listen(h_23759,goog.History.EventType.NAVIGATE,((function (h_23759){
return (function (p1__23757_SHARP_){
return secretary.core.dispatch_BANG_.call(null,p1__23757_SHARP_.token);
});})(h_23759))
);

var G__23758_23760 = h_23759;
G__23758_23760.setEnabled(true);

G__23758_23760.setToken([cljs.core.str(window.location.pathname),cljs.core.str(window.location.search)].join(''));
