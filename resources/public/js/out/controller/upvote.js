...
controller.upvote.upvote_entry = (function controller$upvote$upvote_entry(entry_id){
return ajax.core.PUT.call(null,[cljs.core.str("/upvote/entry/"),cljs.core.str(entry_id)].join(''),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"handler","handler",-195596612),(function (_){
var e = document.getElementById([cljs.core.str("id-upvote-"),cljs.core.str(entry_id)].join(''));
e.style.visibility = "hidden";
